...
from ..services.general_instructions import (
...
class GeneralInstructionsBody(BaseModel):
    section_generic: str
    global_template: str
...
@router.get("/instructions/general")
async def get_general_instructions_route() -> dict[str, str]:
    return get_general_instructions()
